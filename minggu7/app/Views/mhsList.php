<?php
    // pastikan session sudah start di index.php
    echo '<div style="text-align:right; padding:10px;">';
    echo 'Halo, '.$_SESSION['username'].' | <a href="?act=logout">Logout</a>';
    echo '</div>';
?>
						...
						<?php 
                            ...
                            echo '<td>
                                    <form method="POST" action="?act=soft-delete">
                                        ...
                                        <button type="submit" class="btn btn-warning">Hapus Data</button>
                                    </form>
                                  </td>';
                            echo '</tr>';
                        }
